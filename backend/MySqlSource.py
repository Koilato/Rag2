...
# pd->mysql
def insert_vulnerability_data(connection, db_name: str, table_name: str, df: pd.DataFrame) -> int:
    if df.empty:
...
def get_max_id(connection, db_name: str, table_name: str, id_column: str = 'id') -> int:
    """
    获取指定表、指定ID列的最大值。
